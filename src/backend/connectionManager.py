...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, user_id: int):
        ...
        self.active_connections[websocket] = User(ws=websocket, username=f'User {user_id}')
    ...
    async def send_template(self, websocket: WebSocket, template_name: str, context: dict):
